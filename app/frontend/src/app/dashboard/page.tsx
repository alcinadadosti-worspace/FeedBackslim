            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <Card className="bg-primary-50 dark:bg-primary-900/30">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-sm font-bold text-neutral-600 dark:text-neutral-300 uppercase">Gestores</p>
                    <p className="text-3xl font-bold text-neutral-900 dark:text-neutral-100">{data?.stats?.totalGestores || 0}</p>
                  </div>
                </div>
              </Card>
              ...
              <Card className="bg-gold-50 dark:bg-gold-900/20">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-sm font-bold text-neutral-600 dark:text-neutral-300 uppercase">Avaliações</p>
                    <p className="text-3xl font-bold text-neutral-900 dark:text-neutral-100">{data?.stats?.totalAvaliacoes || 0}</p>
                  </div>
                </div>
              </Card>
              ...
              <Card className="bg-neutral-100 dark:bg-neutral-700">
                <div className="flex items-center gap-4">
                  <div className="w-14 h-14 bg-neutral-900 dark:bg-neutral-600 border-3 border-neutral-900 dark:border-neutral-500 flex items-center justify-center">
                    <TrendingUp className="w-7 h-7 text-white" />
                  </div>
                  <div>
                    <p className="text-sm font-bold text-neutral-600 dark:text-neutral-300 uppercase">Suas Avaliações</p>
                    <p className="text-3xl font-bold text-neutral-900 dark:text-neutral-100">{data?.stats?.minhasContribuicoes || 0}</p>
                  </div>
                </div>
              </Card>
            </div>
                  ...
                  <div className="space-y-4">
                    {data?.topGestores?.slice(0, 5).map((gestor: any, index: number) => (
                      <Link
                        ...
                        className="flex items-center gap-4 p-3 border-2 border-neutral-200 dark:border-neutral-700 hover:border-neutral-900 dark:hover:border-neutral-100 hover:bg-neutral-50 dark:hover:bg-neutral-700 transition-all"
                      >
                        ...
                        <div className="flex-1">
                          <p className="font-semibold text-neutral-900 dark:text-neutral-100">{gestor.user?.nome}</p>
                          <p className="text-sm text-neutral-500 dark:text-neutral-400">{gestor.cargo}</p>
                        </div>
                  ...
                  <div className="space-y-4">
                    {data?.minhasAvaliacoes?.map((avaliacao: any) => (
                      ...
                      >
                        ...
                        {avaliacao.elogio && (
                          <p className="text-sm text-neutral-600 dark:text-neutral-300 italic">"{avaliacao.elogio}"</p>
                        )}
                ...
                <Link href="/avaliar">
                  <Card variant="hover" className="bg-primary-50 dark:bg-primary-900/30">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h3 className="font-bold text-lg text-neutral-900 dark:text-neutral-100">Avaliar Gestor</h3>
                        <p className="text-neutral-600 dark:text-neutral-300">Dê seu feedback sobre um gestor</p>
                      </div>
                      <ArrowRight className="w-6 h-6 ml-auto dark:text-neutral-100" />
                    </div>
                  </Card>
                </Link>
                ...
                <Link href="/ouvidoria">
                  <Card variant="hover" className="bg-red-50 dark:bg-red-900/20">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h3 className="font-bold text-lg text-neutral-900 dark:text-neutral-100">Ouvidoria</h3>
                        <p className="text-neutral-600 dark:text-neutral-300">Registre uma denúncia confidencial</p>
                      </div>
                      <ArrowRight className="w-6 h-6 ml-auto dark:text-neutral-100" />
                    </div>
                  </Card>
